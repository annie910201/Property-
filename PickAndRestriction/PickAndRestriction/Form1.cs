...
namespace PickAndRestriction
{
    public partial class Form1 : Form 
    {
        ...
        public void afterKill(ref Button shot,Button enemy,bool run)
        {
            shot.Location = new Point(myself.Location.X + 10, myself.Location.Y * 2);
            shot.Visible = false;
